        ...
        <ImageBackground
          ...
          <View style={styles.contentContainer}>
            <Image
              ...
              source={require('../assets/Boundangle.jpg')}
            />

            <Text style={styles.contentText}>
              Baddha Konasana (Bound Angle Pose) is a go-to pose for opening the hips and stretching the inner thigh muscles. The posture helps you restore your sleeping pattern and treat insomnia. If you practice the pose regularly, it produces a calming effect, capable of helping you achieve a relaxed state of mind.
            </Text>
          </View>
