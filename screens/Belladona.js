...
export default class Belladona extends Component {
  render() {
    return (
        ...
        <ImageBackground
          ...
          <View style={styles.contentContainer}>
            <Image
              ...
              source={require('../assets/belladona.jpg')}
            />

            <Text style={styles.contentText}>
              Belladonna is a solution for delusions and should be given where there is restlessness and anxiety. Such patients tend to spring out of bed and hurt people around, seem to be scared and see objects when they shut their eyes. The speech and actions of the patients are hasty. "To be taken after expert's advice."
            </Text>
          </View>
